...
{
    public static MutationValidationResult<T> Created<T>(T value) => new(MutationResultStatus.Created, value);
    public static MutationValidationResult<T> Updated<T>(T value) => new(MutationResultStatus.Updated, value);
    public static MutationValidationResult<T> NotFound<T>() => new(MutationResultStatus.NotFound);
    public static MutationValidationResult<T> Conflict<T>() => new(MutationResultStatus.Conflict);
    public static MutationValidationResult<T> InvalidToken<T>() => new(MutationResultStatus.InvalidToken);
    public static MutationValidationResult<T> ValidationFailed<T>(ValidationOutcome validation) => new(MutationResultStatus.ValidationFailed, Validation: validation);
}
