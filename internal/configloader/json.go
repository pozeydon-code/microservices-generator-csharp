...
var relationshipSchema = objectSchema{name: "relationship", allowedKeys: allowed("name", "multiplicity", "principalEntity", "dependentEntity", "foreignKeyName", "foreignKeyType", "required", "principalNavigation", "dependentNavigation")}
var serviceSchema = objectSchema{name: "service", allowedKeys: allowed("name", "valueObjects", "entities", "relationships"), arrayTargets: map[string]objectSchema{"valueObjects": valueObjectSchema, "entities": entitySchema, "relationships": relationshipSchema}}
...
var gatewaySchema = objectSchema{name: "gateway", allowedKeys: allowed("enabled")}
var generationSchema = objectSchema{name: "generation", allowedKeys: allowed("targetFramework", "solutionFormat", "enableValueObjectPreflight", "gateway"), objectTargets: map[string]objectSchema{"gateway": gatewaySchema}}
